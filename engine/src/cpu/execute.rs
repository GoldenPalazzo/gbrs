...
impl Cpu {
    pub fn execute(&mut self, bus: &mut MemoryBus, opcode: u8) -> u8 {
        match opcode {
            ...
            0x09 | 0x19 | 0x29 | 0x39 => {
                ...
                self.regs
                    .set_flag(FLAG_H, (hl & 0xfff) + (val & 0xfff) > 0xfff);
            ...
            0xe8 => {
                ...
                self.regs.set_flag(FLAG_N, false);
                self.regs
                    .set_flag(FLAG_H, (sp & 0xf) + (val as u16 & 0xf) > 0xf);
    ...
    fn alu_add(&mut self, val: u8, carry: bool) {
        ...
        self.regs.set_flag(FLAG_N, false);
        self.regs
            .set_flag(FLAG_H, (a & 0xf) + (val & 0xf) + c > 0xf);
        self.regs
            .set_flag(FLAG_C, (a as u16 + val as u16 + c as u16) > 0xff);
    }
